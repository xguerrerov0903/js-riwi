...
while (true){
    ...
    while (true){
        ...
        // Comprobacion de que se haya realizado un valor a la varaible edad 
        if (!edad){
    ...
    // Se comprueba tanto que el valor edad sea  un numero, como que sea un numero positivo
    if (isNaN(edad) || edad<0){
        ...
        alert("Error. Entrada de edad invalidad, ingresa un valor numerico entero positivo")
